...
async def schedule(ATPT_OFCDC_SC_CODE: str, SD_SCHUL_CODE: str, start_date: datetime.datetime = None, end_date : datetime.datetime= None):
    try:
    ...
    url: str = url_manager(type="SchoolSchedule", additions=addition).get_url()
    print(url)
