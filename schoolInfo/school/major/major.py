...
async def major(ATPT_OFCDC_SC_CODE: str, SD_SCHUL_CODE: str = None, auth_key:str=None):
    ...
    url: str = util.url_manager(type="schoolMajorinfo", additions=addition, auth_key=auth_key).get_url()
